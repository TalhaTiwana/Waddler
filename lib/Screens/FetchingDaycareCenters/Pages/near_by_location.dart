...
class _NearByLocationState extends State<NearByLocation> {
      ...
      body: Column(
        children: [
          Expanded(child: Container(
            ...
            child: FutureBuilder(
              future: CloudServer().fetchFromMapByNear(lat: widget.lat,lan: widget.lon),
              builder: (_,snapshot){
                if(snapshot.hasData){
                        ...
                        return InkWell(
                          onTap: (){
                            showBottomSheetCustom(context: context,size: size,
                                ...
                                address: snapshot.data[index].formattedAddress.toString(),
                                name: snapshot.data[index].name,
                                totalRating: snapshot.data[index].userRatingsTotal.toString());
                          },
                          child: Container(
                            margin: EdgeInsets.symmetric(horizontal: size.width*0.05,vertical: size.height*0.02),
                            width: size.width*0.9,
                            height:snapshot.data[index].formattedAddress.toString().length>80? size.height*0.4:size.height*0.35,
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.network("${snapshot.data[index].icon}",scale: 2,),
                                  ),
                                ),
                                Container(
                                          ...
                                          Container(
                                            ...
                                            child: RichText(
                                              text: TextSpan(
                                                  ...
                                                  children: [
                                                    TextSpan(text: "${snapshot.data[index].name}",style: TextStyle(fontSize: size.width*0.033,color: Colors.black,fontWeight: FontWeight.w700,letterSpacing: 0.8,))
                                                  ]
                                              ),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                Text("${snapshot.data[index].rating} ",style: TextStyle(
                                                    color: Colors.black,
                                                    fontWeight: FontWeight.w800,
                                                    fontSize: size.width*0.03
                                                ),),Text("(${snapshot.data[index].userRatingsTotal})")
                                              ],
                                            ),
                                          )
                                        ],
                                      ...
                                      Container(
                                        ...
                                        child: RichText(
                                          text: TextSpan(
                                              ...
                                              children: [
                                                TextSpan(text: "${snapshot.data[index].formattedAddress}",style: TextStyle(fontSize: size.width*0.033,color: Colors.black87,fontWeight: FontWeight.w500,letterSpacing: 0.8,))
                                              ]
                                          ),
                                        ),
                                      ),
  ...
  showBottomSheetCustom({BuildContext context,Size size,String address,String name,String phoneNumber,String totalRating,String rating,}){
