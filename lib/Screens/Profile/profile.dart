...
class _ProfileState extends State<Profile> with TickerProviderStateMixin {
  ...
  TextEditingController _controllerFatherNm = TextEditingController();
  TextEditingController _controllerMotherNm = TextEditingController();
  TextEditingController _controllerPhnNm = TextEditingController();
  TextEditingController _controllerHomeAddressNm = TextEditingController();
  TextEditingController _controllerFatherCNICNm = TextEditingController();
  TextEditingController _controllerMotherCNICNm = TextEditingController();
  TextEditingController _controllerOfficialNm = TextEditingController();
  TextEditingController _controllerChildsName = TextEditingController();
    ...
    setState(() {
     ...
     if(image1!=null){
       Future.delayed(Duration(seconds: 1),(){
         ...
         Toast.show("Updated", context,duration: 1,gravity: 1,backgroundColor: primaryDarkClr,textColor: Colors.white);
  ...
  uploadImageToFireStore({BuildContext buildContext,int code}) async {
   if(code == 1){
     ...
     refParent
         .putFile(Provider.of<AUthProvider>(buildContext,listen: false).imageFileGet())
         .whenComplete(() {
     ...
     refChild
         .putFile(Provider.of<AUthProvider>(buildContext,listen: false).imageFileChildGet())
         .whenComplete(() {
