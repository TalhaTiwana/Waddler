...
class _SignUpScreenParentsState extends State<SignUpScreenParents> {
  ...
  TextEditingController _controllerPhn = TextEditingController();
  TextEditingController _controllerFCNIC = TextEditingController();
  TextEditingController _controllerMCNIC = TextEditingController();
  TextEditingController _controllerHomeAddress = TextEditingController();
  TextEditingController _controllerOffAddress = TextEditingController();
