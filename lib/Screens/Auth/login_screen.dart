...
singIn(BuildContext context)async{
    if(errorOnPassword ==null && errorOnEmail == null){
     ...
     if(data!=null){
       ...
       final snackBar = SnackBar(content: Text("${Provider.of<AUthProvider>(context,listen: false).loginErrorGet()}",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),duration: Duration(seconds:1,milliseconds: 500),backgroundColor: Colors.red[900].withOpacity(1),);
       ScaffoldMessenger.of(context).showSnackBar(snackBar);
     }
    }else{
    if(errorOnEmail!=null){
      final snackBar = SnackBar(content: Text("$errorOnEmail",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),duration: Duration(seconds:1,milliseconds: 500),backgroundColor: Colors.red[900].withOpacity(1),);
      ScaffoldMessenger.of(context).showSnackBar(snackBar);
    }else if(errorOnPassword!=null){
      final snackBar = SnackBar(content: Text("$errorOnPassword",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),duration: Duration(seconds:1,milliseconds: 500),backgroundColor: Colors.red[900].withOpacity(1),);
      ScaffoldMessenger.of(context).showSnackBar(snackBar);
    }
    }
}
